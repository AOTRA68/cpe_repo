...
export default function About() {
  return (
    <div class="justify-center self-center max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
    ...
    <div class="p-5">
        ...
        <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-2 hidden" href="showLess">Show Less</a>
    </div>
</div>
